...
func migrations0002CreateofferstableSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/0002-CreateOffersTable.sql", size: 692, mode: os.FileMode(420), modTime: time.Unix(1490208768, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

...
<<<<<<< HEAD
<<<<<<< HEAD
	info := bindataFileInfo{name: "migrations/0002-CreateOfferTemplatesTable.sql", size: 616, mode: os.FileMode(420), modTime: time.Unix(1488479129, 0)}
=======
	info := bindataFileInfo{name: "migrations/0002-CreateOfferTemplatesTable.sql", size: 641, mode: os.FileMode(420), modTime: time.Unix(1488820689, 0)}
>>>>>>> bb5020a... Key field in Offer and OfferTemplate (feature tests in progress)
=======
	info := bindataFileInfo{name: "migrations/0002-CreateOfferTemplatesTable.sql", size: 641, mode: os.FileMode(420), modTime: time.Unix(1488841284, 0)}
>>>>>>> ff5bf73... New api test
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
=======
	info := bindataFileInfo{name: "migrations/0003-CreateOffersTable.sql", size: 736, mode: os.FileMode(420), modTime: time.Unix(1488821450, 0)}
>>>>>>> bb5020a... Key field in Offer and OfferTemplate (feature tests in progress)
=======
	info := bindataFileInfo{name: "migrations/0003-CreateOffersTable.sql", size: 736, mode: os.FileMode(420), modTime: time.Unix(1488841284, 0)}
>>>>>>> ff5bf73... New api test
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

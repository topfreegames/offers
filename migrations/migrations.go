...
func migrations0002CreateoffertemplatestableSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/0002-CreateOfferTemplatesTable.sql", size: 587, mode: os.FileMode(420), modTime: time.Unix(1487716699, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func migrations0003CreateofferstableSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/0003-CreateOffersTable.sql", size: 577, mode: os.FileMode(420), modTime: time.Unix(1487712778, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

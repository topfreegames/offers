Feature: Create an offer template
  ...
  Scenario Outline: offer template is created
    ...
    Examples:
      | name | key                                  | pid            | contents   | metadata   | period       | frequency          | trigger                                 | placement |
      | oc1  | 05f69798-7720-43d2-acd4-92fe0c11e2b1 | com.tfg.sample | { 'x': 1 } | { 'y': 2 } | { 'max': 1 } | { 'every': '50s' } | { 'from': 1486678078, 'to': 1486678079} | popup     |
  ...
  Scenario Outline: can't create offer template with same name
    ...
    Examples:
      | name | key                                  | pid            | contents   | metadata   | period       | frequency          | trigger                                 | placement |
      | oc2  | 05f69798-7720-43d2-acd4-92fe0c11e2b1 | com.tfg.sample | { 'x': 1 } | { 'y': 2 } | { 'max': 1 } | { 'every': '50s' } | { 'from': 1486678078, 'to': 1486678079} | popup     |
  ...
  Scenario Outline: can't create offer template with invalid payload
    ...
    Examples:
      ...
      | oc3  | 05f69798-7720-43d2-acd4-92fe0c11e2b1 | com.tfg.sample | { 'x': 1 } | { 'y': 2 } | { 'max': 1 } |                    | { 'from': 1486678078, 'to': 1486678079} | popup     | The frequency is required to create a new offer template.  |
      | oc3  | 05f69798-7720-43d2-acd4-92fe0c11e2b1 | com.tfg.sample | { 'x': 1 } | { 'y': 2 } | { 'max': 1 } | { 'every': '50s' } |                                         | popup     | The trigger is required to create a new offer template.    |
      | oc3  | 05f69798-7720-43d2-acd4-92fe0c11e2b1 | com.tfg.sample | { 'x': 1 } | { 'y': 2 } | { 'max': 1 } | { 'every': '50s' } | { 'from': 1486678078, 'to': 1486678079} |           | The placement is required to create a new offer template.  |

Feature: Create an offer template
  ...
  Scenario: can't create offer template with same name
    ...
    When an offer template is created in the "offer-template-game" game with:
      | name | product_id     | contents   | metadata   | period             | trigger                                  |
      | oc2  | com.tfg.sample | { "x": 1 } | { "y": 2 } | { "type": "once" } | { "from": 1486678078, "to": 1486678079} |
  ...
  Scenario Outline: can't create offer template with invalid payload
    ...
    Examples:
      ...
      |      | com.tfg.sample | { "x": 1 } | { "y": 2 } | { "type": "once" } | { "from": 1486678078, "to": 1486678079} | The name is required to create a new offer template.       |
      | oc3  |                | { "x": 1 } | { "y": 2 } | { "type": "once" } | { "from": 1486678078, "to": 1486678079} | The product id is required to create a new offer template. |
      | oc3  | com.tfg.sample |            | { "y": 2 } | { "type": "once" } | { "from": 1486678078, "to": 1486678079} | The contents are required to create a new offer template.  |
